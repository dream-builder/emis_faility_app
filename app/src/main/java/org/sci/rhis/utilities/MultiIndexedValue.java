 ...
 */
public class MultiIndexedValue extends IndexedValue {

    protected int dropdownArrayResource;
    private boolean readFromDb = false;
    private JSONArray jsonArray = null;

    public MultiIndexedValue(Context context, String key, String value, String displayLabel, Integer [] arguments) {
    ...
    private void loadDbResult() {
        ...
        jsonArray = CommonQueryExecution.getDropDownListAsJSONArray(table_name,"serviceid=10");
    }
            ...
            for (String value : selectedValues) {
                if (readFromDb) {
                    ...
                    for (int i = 0; i < jsonArray.length() && !idFound; i++) {
                        ...
                        if(Integer.parseInt(value) == item.getInt("id")) {
    ...
    public String toString() {
        String result = displayLabel + ((value.equals("[]") || value.equals("[\"\"]") || value.equals(""))?
