...
import org.sci.rhis.db.fp.FPInfo;
import org.sci.rhis.utilities.Utilities;

/**
 * Created by arafat.hasan on 8/24/2016.
 */
public class AsyncFPInfoUpdate extends SendPostRequestAsyncTask{

    private final String LOGTAG = "FPINFO-ASYNCTASK";

    public AsyncFPInfoUpdate(AsyncCallback cb, Activity activity) {
        super(cb, activity);
    }
    ...
    protected String doOfflineJobs(String jsonRequest) {
        ...
        try {
            ...
            result = FPInfo.getDetailInfo(json).toString();
