...
import org.sci.rhis.db.dbhelper.ClientAdvanceSearch;
...
public class AsyncADVSearchUpdate extends SendPostRequestAsyncTask {
    ...
    public AsyncADVSearchUpdate(AsyncCallback cb, Activity activity) {
        super(cb, activity);
    }
    private final String LOGTAG = "FWC-ADVSEARCH-ASYNCTASK";
    ...
    protected String doOfflineJobs(String jsonRequest) {
        ...
        try {
            ...
            result = ClientAdvanceSearch.getSearchResult(searchJson).toString();
