...
import org.sci.rhis.db.iud.IUDInfo;
import org.sci.rhis.utilities.Utilities;

/**
 * Created by arafat.hasan on 3/10/2016.
 */
public class AsyncIUDInfoUpate extends SendPostRequestAsyncTask{

    private final String LOGTAG = "FWC-IUD-ASYNCTASK";

    public AsyncIUDInfoUpate(AsyncCallback origin, Activity activity) {
    ...
    protected String doOfflineJobs(String jsonRequest) {
        ...
        try {
            ...
            result = IUDInfo.getDetailInfo(json).toString();
