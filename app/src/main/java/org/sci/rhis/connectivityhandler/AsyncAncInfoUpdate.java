...
import org.sci.rhis.db.anc.ANCVisit;
...
public class AsyncAncInfoUpdate extends SendPostRequestAsyncTask{
    ...
    private final String LOGTAG = "FWC-ANC-ASYNCTASK";


    public AsyncAncInfoUpdate(AsyncCallback cb, Activity activity) {
        super(cb, activity);
    }
    ...
    protected String doOfflineJobs(String jsonRequest) {
        ...
        try {
            ...
            result = ANCVisit.getDetailInfo(json).toString();
